...
use protocol::oicq;
use rand::Rng;
use core::sync::atomic::{AtomicI32,AtomicI64,AtomicU16,Ordering};
use protocol::device::Device;
use protocol::transport::Transport;
use protocol::version::Version;
pub use crypto::CoreCryptoRng;
pub use provider::*;
...
impl Engine {
    pub fn new(device: Device, version: &'static Version) -> Self {
        Self {
            ...
            group_seq: AtomicI32::new(get_random_provider().gen_range(0..20000)),
            friend_seq: AtomicI32::new(get_random_provider().gen_range(0..20000)),
            group_data_trans_seq: AtomicI32::new(get_random_provider().gen_range(0..20000)),
            highway_apply_up_seq: AtomicI32::new(get_random_provider().gen_range(0..20000)),
        }
    }
