...
jce_struct!(HttpServerListRes {
    2 => sso_server_infos: Vec<SsoServerInfo>,
});

jce_struct!(SsoServerInfo {
    1 => server: String,
    2 => port: i32,
    8 => location: String,
});

jce_struct!(FileStoragePushFSSvcList {
...
jce_struct!(FileStorageServerInfo {
    1 => server: String,
    2 => port: i32,
});

jce_struct!(BigDataChannel {
...
jce_struct!(BigDataIPList {
    0 => service_type: i64,
    1 => ip_list: Vec<BigDataIPInfo>,
    3 => fragment_size: i64,
});

jce_struct!(BigDataIPInfo {
    0 => r#type: i64,
    1 => server: String,
    2 => port: i64,
});

jce_struct!(SvcReqPullGroupMsgSeq {
    0 => group_info: Vec<PullGroupSeqParam>,
    1 => verify_type: u8,
    2 => filter: i32,
});

jce_struct!(SvcReqRegister {
    0  => uin: i64,
    1  => bid: i64,
    2  => conn_type: u8,
    3  => other: String,
...
jce_struct!(PullGroupSeqParam {
    0 => group_code: i64,
    1 => last_seq_id: i64,
});

jce_struct!(SvcRespParam {
    0 => pc_stat: i32,
...
jce_struct!(SvcReqMSFLoginNotify {
    0 => app_id: i64,
    1 => status: u8,
    2 => tablet: u8,
    3 => platform: i64,
...
jce_struct!(SvcReqGetDevLoginInfo {
    0 => guid: Bytes,
    1 => app_name: String,
    2 => login_type: i64,
    3 => timestamp: i64,
...
jce_struct!(ModifyGroupCardRequest {
    0 => zero: i64,
    1 => group_code: i64,
    2 => new_seq: i64,
...
jce_struct!(SummaryCardReqSearch {
    0 => keyword: String,
...
mod tests {
    ...
    fn sso_address_resp_decode() {
        init();
        const SSO_ADDRESS_RESP: &str = "";
        ...
        let sso_server_infos: HttpServerListRes = jcers::from_buf(
            ...
            .unwrap();
        let expect_infos = [
            ("109.244.198.14",8080i32),
            ("180.102.111.105",8080),
            ("113.96.12.85",8080),
            ("14.22.3.122",443),
            ("42.81.193.250",80),
            ("114.221.148.49",14000),
            ("113.96.13.95",443),
            ("42.81.192.211",8080),
            ("101.91.42.98",80),
        ...
        for (idx,s) in sso_server_infos.sso_server_infos.iter().enumerate() {
            if let Some((addr,port)) = expect_infos.get(idx) {
                assert_eq!((s.server.as_str(),s.port),(*addr,*port));
            } else {
                assert_eq!(sso_server_infos.sso_server_infos.len(),11);
            }
        }
    }
}
